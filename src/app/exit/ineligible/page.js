    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col font-sans">
      ...
      <main className="flex-grow flex flex-col items-center justify-center py-16 px-4 md:px-8">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12 text-center animate-fadeIn">
          {/* Card Icon */}
          <div className="mx-auto w-20 h-20 bg-red-50 rounded-full flex items-center justify-center mb-8 border border-red-100 shadow-xs">
            <IconUserX className="w-10 h-10 text-red-500" stroke={1.5} />
          </div>
          ...
          <p className="text-gray-600 text-base md:text-[17px] font-medium leading-relaxed mb-8 max-w-lg mx-auto">
            Based on the screening results, you do not currently meet the eligibility criteria to participate in this study. 
            We sincerely appreciate your time and willingness to support our research.
          </p>

          {/* Support Information Box */}
          <div className="bg-[#fdf9f9] rounded-xl border border-red-100/50 p-6 text-left mb-8 max-w-md mx-auto shadow-2xs">
            <h3 className="text-[#04284b] font-bold text-sm mb-3 flex items-center tracking-wide uppercase">
              <IconHeart className="w-4.5 h-4.5 text-red-500 mr-2" />
              Support Resources
            </h3>
